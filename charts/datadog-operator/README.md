...
![Version: 2.14.3](https://img.shields.io/badge/Version-2.14.3-informational?style=flat-square) ![AppVersion: 1.19.1](https://img.shields.io/badge/AppVersion-1.19.1-informational?style=flat-square)
...
| image.tag | string | `"1.19.1"` | Define the Datadog Operator version to use |
