...
![Version: 2.23.0-dev.4](https://img.shields.io/badge/Version-2.23.0--dev.4-informational?style=flat-square) ![AppVersion: 1.27.0-rc.2](https://img.shields.io/badge/AppVersion-1.27.0--rc.2-informational?style=flat-square)
...
| image.tag | string | `"1.27.0-rc.2"` | Define the Datadog Operator version to use |
