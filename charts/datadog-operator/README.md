...
![Version: 2.28.0-dev.2](https://img.shields.io/badge/Version-2.28.0--dev.2-informational?style=flat-square) ![AppVersion: 1.31.0-rc.1](https://img.shields.io/badge/AppVersion-1.31.0--rc.1-informational?style=flat-square)
...
| image.tag | string | `"1.31.0-rc.1"` | Define the Datadog Operator version to use |
