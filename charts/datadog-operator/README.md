...
datadog/datadog-crds	0.6.0        	1          	Datadog Kubernetes CRDs chart
```

and for the Datadog Opetator chart:
...
Then you will need to install the cert manager if you don't have it already:
