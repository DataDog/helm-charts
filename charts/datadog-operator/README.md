...
![Version: 2.18.0](https://img.shields.io/badge/Version-2.18.0-informational?style=flat-square) ![AppVersion: 1.23.0-rc.3](https://img.shields.io/badge/AppVersion-1.23.0--rc.3-informational?style=flat-square)
...
| image.tag | string | `"1.23.0-rc.3"` | Define the Datadog Operator version to use |
