...
| image.tag | string | `"1.30.0-rc.3"` | Define the Datadog Operator version to use |
...
| podDisruptionBudget | object | `{}` | Set the PodDisruptionBudget spec of the Datadog Operator PODs, only created when replicaCount is greater than 1 |
