...
* Add `registryMigrationMode` to control gradual migration of agent image pulls to registry.datadoghq.com. Defaults to "auto", which currently enables the ASIA region override (ap1.datadoghq.com). More sites will be enabled in future releases. Set to "" to disable. ([#2421](https://github.com/DataDog/helm-charts/pull/2421)).
