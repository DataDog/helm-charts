...
![Version: 2.37.0](https://img.shields.io/badge/Version-2.37.0-informational?style=flat-square) ![AppVersion: 7](https://img.shields.io/badge/AppVersion-7-informational?style=flat-square)
...
| agents.image.tag | string | `"7.38.0"` | Define the Agent version to use |
...
| clusterChecksRunner.image.tag | string | `"7.38.0"` | Define the Agent version to use |
