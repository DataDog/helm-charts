...
| clusterAgent.existingService | string | `nil` | Existing service name to use for reaching the Cluster Agent, useful if you have a Cluster Agent deployed outside of this chart release |
...
| clusterAgent.tokenExistingSecret | string | `nil` | Existing secret name to use for Cluster Agent token, useful if you have a Cluster Agent deployed outside of this chart release |
