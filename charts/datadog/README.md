...
| datadog.kubeStateMetricsCore.collectConfigMapCount | bool | `false` | Enable this to collect the count of ConfigMaps in the cluster |
| datadog.kubeStateMetricsCore.collectSecretCount | bool | `false` | Enable this to collect the count of Secrets in the cluster  |
