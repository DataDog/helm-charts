...
| clusterAgent.podDisruptionBudget | object | `{"minAvailable":1}` | Create pod disruption budget for Cluster Agent deployments |
...
| clusterChecksRunner.podDisruptionBudget | object | `{"maxUnavailable":1}` | Create pod disruption budget for Cluster Checks Runner deployments |
