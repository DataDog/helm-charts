...
![Version: 3.101.2](https://img.shields.io/badge/Version-3.101.2-informational?style=flat-square) ![AppVersion: 7](https://img.shields.io/badge/AppVersion-7-informational?style=flat-square)
...
| datadog.otelCollector.featureGates | string | `""` | Feature gates to pass to OTel collector, as a comma separated list |
