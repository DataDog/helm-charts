...
![Version: 2.30.12](https://img.shields.io/badge/Version-2.30.12-informational?style=flat-square) ![AppVersion: 7](https://img.shields.io/badge/AppVersion-7-informational?style=flat-square)
...
| agents.shareProcessNamespace | boolean | `true` | Enable process namespace sharing for Datadog Agent's Daemonset pods. |
...
| clusterAgent.shareProcessNamespace | boolean | `true` | Enable process namespace sharing for Cluster Agent pods. |
...
| clusterChecksRunner.shareProcessNamespace | boolean | `true` | Enable process namespace sharing for ClusterChecks pods. |
