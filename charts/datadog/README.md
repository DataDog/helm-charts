...
| agents.containers.processAgent.env | list | `[]` | Additional environment variables for the process-agent container BREAKING: from Agent 7.85.0 this container takes its configuration from the Agent and drops its own environment on startup, so variables set here will have no effect; set them on the Agent instead, through datadog.env or agents.containers.agent.env. |
| agents.containers.processAgent.envDict | object | `{}` | Set environment variables specific to process-agent defined in a dict BREAKING: from Agent 7.85.0 this container takes its configuration from the Agent and drops its own environment on startup, so variables set here will have no effect; set them on the Agent instead, through datadog.env or agents.containers.agent.env. |
| agents.containers.processAgent.envFrom | list | `[]` | Set environment variables specific to process-agent from configMaps and/or secrets BREAKING: from Agent 7.85.0 this container takes its configuration from the Agent and drops its own environment on startup, so variables set here will have no effect; set them on the Agent instead, through datadog.env or agents.containers.agent.env. |
...
| agents.containers.securityAgent.env | list | `[]` | Additional environment variables for the security-agent container BREAKING: from Agent 7.85.0 this container takes its configuration from the Agent and drops its own environment on startup, so variables set here will have no effect; set them on the Agent instead, through datadog.env or agents.containers.agent.env. |
| agents.containers.securityAgent.envDict | object | `{}` | Set environment variables specific to security-agent defined in a dict BREAKING: from Agent 7.85.0 this container takes its configuration from the Agent and drops its own environment on startup, so variables set here will have no effect; set them on the Agent instead, through datadog.env or agents.containers.agent.env. |
| agents.containers.securityAgent.envFrom | list | `[]` | Set environment variables specific to security-agent from configMaps and/or secrets BREAKING: from Agent 7.85.0 this container takes its configuration from the Agent and drops its own environment on startup, so variables set here will have no effect; set them on the Agent instead, through datadog.env or agents.containers.agent.env. |
...
| agents.containers.systemProbe.env | list | `[]` | Additional environment variables for the system-probe container BREAKING: from Agent 7.85.0 this container takes its configuration from the Agent and drops its own environment on startup, so variables set here will have no effect; set them on the Agent instead, through datadog.env or agents.containers.agent.env. |
| agents.containers.systemProbe.envDict | object | `{}` | Set environment variables specific to system-probe defined in a dict BREAKING: from Agent 7.85.0 this container takes its configuration from the Agent and drops its own environment on startup, so variables set here will have no effect; set them on the Agent instead, through datadog.env or agents.containers.agent.env. |
| agents.containers.systemProbe.envFrom | list | `[]` | Set environment variables specific to system-probe from configMaps and/or secrets BREAKING: from Agent 7.85.0 this container takes its configuration from the Agent and drops its own environment on startup, so variables set here will have no effect; set them on the Agent instead, through datadog.env or agents.containers.agent.env. |
...
| agents.containers.traceAgent.env | list | `[]` | Additional environment variables for the trace-agent container BREAKING: from Agent 7.85.0 this container takes its configuration from the Agent and drops its own environment on startup, so variables set here will have no effect; set them on the Agent instead, through datadog.env or agents.containers.agent.env. |
| agents.containers.traceAgent.envDict | object | `{}` | Set environment variables specific to trace-agent defined in a dict BREAKING: from Agent 7.85.0 this container takes its configuration from the Agent and drops its own environment on startup, so variables set here will have no effect; set them on the Agent instead, through datadog.env or agents.containers.agent.env. |
| agents.containers.traceAgent.envFrom | list | `[]` | Set environment variables specific to trace-agent from configMaps and/or secrets BREAKING: from Agent 7.85.0 this container takes its configuration from the Agent and drops its own environment on startup, so variables set here will have no effect; set them on the Agent instead, through datadog.env or agents.containers.agent.env. |
