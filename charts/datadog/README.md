...
| `agents.deployment`                                          | If true, the agent will run as a deployment instead of a daemonset                                                                                                                                                                                                                                  | `false`                                           |
| `agents.replicaCount`                                        | Set the number of agent replicas for when the agent runs as deployment                                                                                                                                                                                                                              | `1`                                               |
