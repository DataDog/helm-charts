...
![Version: 2.27.10](https://img.shields.io/badge/Version-2.27.10-informational?style=flat-square) ![AppVersion: 7](https://img.shields.io/badge/AppVersion-7-informational?style=flat-square)
...
| agents.containers.systemProbe.securityContext | object | `{"capabilities":{"add":["SYS_ADMIN","SYS_RESOURCE","SYS_PTRACE","NET_ADMIN","NET_BROADCAST","NET_RAW","IPC_LOCK","SYS_CHOWN"]},"privileged":false}` | Allows you to overwrite the default container SecurityContext for the system-probe container. |
...
| agents.image.tag | string | `"7.32.3"` | Define the Agent version to use |
...
| clusterChecksRunner.image.tag | string | `"7.32.3"` | Define the Agent version to use |
