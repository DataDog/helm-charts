...
| agents.image.tag | string | `"7.56.1"` | Define the Agent version to use |
...
| clusterAgent.image.tag | string | `"7.56.1"` | Cluster Agent image tag to use |
...
| clusterChecksRunner.image.tag | string | `"7.56.1"` | Define the Agent version to use |
