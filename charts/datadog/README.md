...
![Version: 3.185.0](https://img.shields.io/badge/Version-3.185.0-informational?style=flat-square) ![AppVersion: 7](https://img.shields.io/badge/AppVersion-7-informational?style=flat-square)
...
| otelAgentGateway.containers.otelAgent.livenessProbe | object | Every 15s / 6 KO / 1 OK | Override default otel-agent-gateway liveness probe settings |
...
| otelAgentGateway.containers.otelAgent.readinessProbe | object | Every 15s / 6 KO / 1 OK | Override default otel-agent-gateway readiness probe settings |
