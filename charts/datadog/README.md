...
| agents.shareProcessNamespace | bool | `true` | Set the process namespace sharing on the Datadog Daemonset |
...
| clusterAgent.shareProcessNamespace | bool | `true` | Set the process namespace sharing on the Datadog Cluster Agent |
...
| datadog.clusterChecks.shareProcessNamespace | bool | `true` | Set the process namespace sharing on the cluster checks agent |
