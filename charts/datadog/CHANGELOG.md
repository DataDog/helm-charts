...
**_Warning:_** From this version onwards, on GKE Autopilot, only one "datadog" Helm chart release is allowed by Kubernetes namespace due to the following new constraints:
...
- Add support of DD_CONTAINER\_{INCLUDE,EXCLUDE}\_{METRICS,LOGS}
...
- Add "rate*limit_queries*\*" in the datadog.cluster-agent prometheus check configuration
