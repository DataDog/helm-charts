...
![Version: 0.17.27](https://img.shields.io/badge/Version-0.17.27-informational?style=flat-square) ![AppVersion: 1.69.0](https://img.shields.io/badge/AppVersion-1.69.0-informational?style=flat-square)
...
| image.tag | string | `"1.69.0"` | Define the Datadog Synthetics Private Location version to use |
