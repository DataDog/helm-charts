...
![Version: 0.14.4](https://img.shields.io/badge/Version-0.14.4-informational?style=flat-square) ![AppVersion: 1.26.0](https://img.shields.io/badge/AppVersion-1.26.0-informational?style=flat-square)
...
| image.tag | string | `"1.26.0"` | Define the Datadog Synthetics Private Location version to use |
