...
![Version: 0.13.4](https://img.shields.io/badge/Version-0.13.3-informational?style=flat-square) ![AppVersion: 1.23.0](https://img.shields.io/badge/AppVersion-1.23.0-informational?style=flat-square)
...
| image.tag | string | `"1.23.0"` | Define the Datadog Synthetics Private Location version to use |
