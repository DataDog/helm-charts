...
![Version: 0.17.29](https://img.shields.io/badge/Version-0.17.29-informational?style=flat-square) ![AppVersion: 1.70.0](https://img.shields.io/badge/AppVersion-1.70.0-informational?style=flat-square)
...
| image.tag | string | `"1.70.0"` | Define the Datadog Synthetics Private Location version to use |
