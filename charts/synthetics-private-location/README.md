...
![Version: 0.12.0](https://img.shields.io/badge/Version-0.12.0-informational?style=flat-square) ![AppVersion: 1.18.1](https://img.shields.io/badge/AppVersion-1.18.0-informational?style=flat-square)
...
| image.tag | string | `"1.18.1"` | Define the Datadog Synthetics Private Location version to use |
