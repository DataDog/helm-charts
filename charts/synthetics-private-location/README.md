...
![Version: 0.17.9](https://img.shields.io/badge/Version-0.17.9-informational?style=flat-square) ![AppVersion: 1.56.1](https://img.shields.io/badge/AppVersion-1.56.1-informational?style=flat-square)
...
| image.tag | string | `"1.56.1"` | Define the Datadog Synthetics Private Location version to use |
