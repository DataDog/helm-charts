...
![Version: 2.20.5](https://img.shields.io/badge/Version-2.20.5-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 2.20.4](https://img.shields.io/badge/AppVersion-2.20.4-informational?style=flat-square)
...
| image.tag | string | `"2.20.4"` | Specify the image tag to use. |
