...
- Add support for custom scripts via `runner.scriptFiles` and `runner.scriptConfigMaps`
- Scripts are mounted in `/home/scriptuser/` directory
- Support for inline script files and external ConfigMaps containing scripts
