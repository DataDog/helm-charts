...
![Version: 0.15.2](https://img.shields.io/badge/Version-0.15.2-informational?style=flat-square) ![AppVersion: v0.1.7-beta](https://img.shields.io/badge/AppVersion-v0.1.7--beta-informational?style=flat-square)
...
|-----|------|---------|-------------|
| common.image | object | `{"repository":"gcr.io/datadoghq/private-action-runner","tag":"v0.1.7-beta"}` | Current Datadog Private Action Runner image |
