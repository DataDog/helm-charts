...
![Version: 0.15.7](https://img.shields.io/badge/Version-0.15.7-informational?style=flat-square) ![AppVersion: v0.1.12-beta](https://img.shields.io/badge/AppVersion-v0.1.12--beta-informational?style=flat-square)
...
|-----|------|---------|-------------|
| common.image | object | `{"repository":"gcr.io/datadoghq/private-action-runner","tag":"v0.1.12-beta"}` | Current Datadog Private Action Runner image |
