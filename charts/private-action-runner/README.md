...
![Version: 0.15.8](https://img.shields.io/badge/Version-0.15.8-informational?style=flat-square) ![AppVersion: v0.1.13-beta](https://img.shields.io/badge/AppVersion-v0.1.13--beta-informational?style=flat-square)
...
|-----|------|---------|-------------|
| common.image | object | `{"repository":"gcr.io/datadoghq/private-action-runner","tag":"v0.1.13-beta"}` | Current Datadog Private Action Runner image |
