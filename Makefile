...
# version noise, so a real datadog-crds schema change still needs it
# regenerated by hand - see release-operator.sh, which deliberately does NOT
# call this automatically (CONTP-2001). Scoped to the Test_baseline_crd
